...
(function () {
  ...
  var prettyPrint = (function () {
    ...
    (function () {
      ...
      var COMMON_KEYWORDS = [C_KEYWORDS,"catch,class,del,false,import," +
      ...
      var JSCRIPT_KEYWORDS = [COMMON_KEYWORDS,
          ...
          "Infinity,NaN"];
      var PERL_KEYWORDS = "caller,del,die,do,dump,elsif,eval,exit,foreach,for," +
       ...
       * @const
       */
      var REGEXP_PRECEDER_PATTERN = '(?:^^\\.?|[+-]|[!=]=?=?|\\#|%=?|&&?=?|\\(|\\*=?|[+\\-]=|->|\\/=?|::?|<<?=?|>>?>?=?|,|;|\\?|@|\\[|~|{|\\^\\^?=?|\\|\\|?=?|break|case|continue|del|do|else|finally|instanceof|return|throw|try|typeof)\\s*';
