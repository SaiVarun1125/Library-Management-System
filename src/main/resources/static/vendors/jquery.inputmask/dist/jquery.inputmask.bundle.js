    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function setValidPosition(pos, validTest, fromSetValid, isSelection) {
            if (isSelection || opts.insertMode && void 0 !== getMaskSet().validPositions[pos] && void 0 === fromSetValid) {
                ...
                for (i = pos; lvp >= i; i++) del getMaskSet().validPositions[i];
        ...
        function stripValidPositions(start, end, nocheck, strict) {
            ...
            for (getMaskSet().p = start, i = end - 1; i >= startPos; i--) void 0 !== getMaskSet().validPositions[i] && (nocheck === !0 || !IsEnclosedStatic(i) && opts.canClearPosition(getMaskSet(), i, getLastValidPosition(), strict, opts) !== !1) && del getMaskSet().validPositions[i];
            for (resetMaskSet(!0), i = startPos + 1; i <= getLastValidPosition(); ) {
                ...
                if (startPos > i && (i = startPos + 1), void 0 === getMaskSet().validPositions[i] && isMask(i) || void 0 !== s) i++; else {
                    ...
                    getMaskSet().validPositions[startPos].input = t.input, del getMaskSet().validPositions[i], 
                    i++) : positionCanMatchDefinition(startPos, t.match.def) ? isValid(startPos, t.input || getPlaceholder(i), !0) !== !1 && (del getMaskSet().validPositions[i], 
        ...
        function getBuffer(noCache) {
            if (void 0 === getMaskSet().buffer || noCache === !0) {
                if (noCache === !0) for (var testNdx in getMaskSet().tests) void 0 === getMaskSet().validPositions[testNdx] && del getMaskSet().tests[testNdx];
        ...
        function refreshFromBuffer(start, end, buffer) {
            var i;
            if (buffer = buffer, start === !0) resetMaskSet(), start = 0, end = buffer.length; else for (i = start; end > i; i++) del getMaskSet().validPositions[i], 
            del getMaskSet().tests[i];
                        ...
                        for (var mndx = 0; mndx < altNdxs.length; mndx++) {
                            ...
                            if (decisionTaker < altNdxs[mndx]) {
                                ...
                                if (decisionTaker !== possibilityPos.locator[alternation]) {
                                    ...
                                    del getMaskSet().validPositions[i], del getMaskSet().tests[i];
            ...
            function generalize() {
                if (opts.keepStatic) {
                    ...
                    for (lastAlt = getLastValidPosition(); lastAlt >= 0; lastAlt--) {
                        ...
                        del getMaskSet().validPositions[lastAlt], void 0 !== validPos.alternation && validPos.locator[validPos.alternation] === getTestTemplate(lastAlt).locator[validPos.alternation])) break;
                    }
            ...
            off: function(input, event) {
                if (input.inputmask && input.inputmask.events) {
                    ...
                    $.each(events, function(eventName, evArr) {
                        ...
                        del input.inputmask.events[eventName];
                    });
                }
            }
        };
                ...
                if (e && ("blur" === e.type || "checkval" === e.type || "keydown" === e.type)) {
                    ...
                    "" !== processValue && isFinite(processValue)) {
                        ...
                        isFinite(opts.digits)) {
                            ...
                            processValue[processValue.length - 1] === opts.radixPoint && del processValue[processValue.length - 1];
                        }
