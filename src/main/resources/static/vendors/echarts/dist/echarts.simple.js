...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * @return {module:echarts/mdl/Global}
	     */
	    ...
	    var updateMethods = {
	        ...
	        update: function (payload) {
	            ...
	            // In LineView may sve the old coordinate system and use it to get the orignal point
	     ...
	     * @param  {module:echarts/mdl/Global} ecModel
	     * @private
	     */
	    function prepareView(type, ecModel) {
	        ...
	        ecModel[isComponent ? 'eachComponent' : 'eachSeries'](function (componentType, mdl) {
	            if (isComponent) {
	            ...
	            var viewId = mdl.id + '_' + mdl.type;
	            var view = viewMap[viewId];
	            if (!view) {
	                var classType = ComponentModel.parseClassType(mdl.type);
	    ...
	    echartsProto.dispose = function () {
	        ...
	        del instances[this.id];
	    };

	    zrUtil.mixin(ECharts, Eventful);

	    /**
	     * @param {module:echarts/mdl/Series|module:echarts/mdl/Component} mdl
	     * @param {module:echarts/view/Component|module:echarts/view/Chart} view
	     * @return {string}
	     */
	    function updateZ(mdl, view) {
	        var z = mdl.get('z');
	        var zlevel = mdl.get('zlevel');
	        // Set z and zlevel
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * @alias module:echarts/mdl/Global
	     *
	     * @param {Object} option
	     * @param {module:echarts/mdl/Model} parentModel
	     * @param {Object} theme
	     */
	    var GlobalModel = Model.extend({
	        ...
	        init: function (option, parentModel, theme, optionManager) {
	            ...
	            /**
	             * @type {module:echarts/mdl/OptionManager}
	             */
	        ...
	        mergeOption: function (newOption) {
	            ...
	            // 如果不存在对应的 component mdl 则直接 merge
	         ...
	         * @param {number} [idx=0]
	         * @return {module:echarts/mdl/Component}
	         */
	         ...
	         * @return {Array.<module:echarts/mdl/Component>}
	         */
	         ...
	         *     ...
	         * });
	         * eachComponent(function (componentType, mdl, index) {
	        ...
	        /**
	         * @param {string} name
	         * @return {Array.<module:echarts/mdl/Series>}
	         */
	         ...
	         * @return {module:echarts/mdl/Series}
	         */
	        ...
	        /**
	         * @param {module:echarts/mdl/Series} seriesModel
	         */
	    ...
	    function mergeTheme(option, theme) {
	        for (var name in theme) {
	            // 如果有 component mdl 则把具体的 merge 逻辑交给该 mdl 处理
	    ...
	    function initBase(baseOption) {
	        ...
	        /**
	         * @type {Object.<string, Array.<module:echarts/mdl/Model>>}
	         * @private
	         */
	        this._componentsMap = {};
	    ...
	    /**
	     * @inner
	     * @param {Array.<string>|string} types mdl types
	    ...
	    function makeKeyInfo(mainType, mapResult) {
	        ...
	        // no-merge mode. So we generate mdl id by name and plus
	        // type in view id.
...
/***/ function(module, exports, __webpack_require__) {
	     ...
	     *
	     * @public
	     * @param {Array.<Object>|Array.<module:echarts/mdl/Component>} exists
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * @alias module:echarts/mdl/Model
	     * @constructor
	     * @param {Object} option
	     * @param {module:echarts/mdl/Model} [parentModel]
	     * @param {module:echarts/mdl/Global} [ecModel]
	    ...
	    function Model(option, parentModel, ecModel, extraOpt) {
	        ...
	        /**
	         * @type {module:echarts/mdl/Global}
	         * @readOnly
	         */
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    function getShallow(mdl, path) {
	        return mdl && mdl.getShallow(path);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * @alias module:echarts/mdl/Component
	     * @constructor
	     * @param {Object} option
	     * @param {module:echarts/mdl/Model} parentModel
	     * @param {module:echarts/mdl/Model} ecModel
	     */
	    var ComponentModel = Model.extend({
	        ...
	        /**
	         * key: componentType
	         * value:  Component mdl list, can not be null.
	         * @type {Object.<string, Array.<module:echarts/mdl/Model>>}
	         * @readOnly
	         */
	        dependentModels: [],
	        ...
	        entity.topologicalTravel = function (targetNameList, fullNameList, callback, context) {
	            ...
	            while (stack.length) {
	                ...
	                if (isInTargetNameSet) {
	                    ...
	                    del targetNameSet[currComponentType];
	                }
	                zrUtil.each(
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 * @module {echarts/mdl/OptionManager}
	 */
	     ...
	     *     };
	     *
	     * @alias module:echarts/mdl/OptionManager
	     ...
	     * 1. Each mdl handle its self restoration but not uniform treatment.
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	     ...
	     * @param {module:echarts/mdl/Model} labelModel
	     * @param {string} color
	     */
	     ...
	     * @param {module:zrender/Element} el
	     * @param {Object} props
	     * @param {module:echarts/mdl/Model} [animatableModel]
	     * @param {number} [dataIndex]
	     * @param {Function} [cb]
	     * @example
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	     ...
	     * @param {module:echarts/mdl/Model} hostModel
	     */
	    var List = function (dimensions, hostModel) {
	         ...
	         * @type {Array.<module:echarts/mdl/Model>}
	         * @private
	         */
	        this._optionModels = [];
	...
	var factory = exports;
	    ...
	    gridProto.update = function (ecModel, api) {
	        ...
	        each(axesMap.x, function (xAxis) {
	            niceScaleExtent(xAxis, xAxis.mdl);
	        });
	        each(axesMap.y, function (yAxis) {
	            niceScaleExtent(yAxis, yAxis.mdl);
	        });
	        // Fix configuration
	        each(axesMap.x, function (xAxis) {
	    ...
	    gridProto.resize = function (gridModel, api) {
	        ...
	        if (gridModel.get('containLabel')) {
	            each(axesList, function (axis) {
	                if (!axis.mdl.get('axisLabel.inside')) {
	                    var labelUnionRect = getLabelUnionRect(axis);
	                    if (labelUnionRect) {
	                        var dim = axis.isHorizontal() ? 'height' : 'width';
	                        var margin = axis.mdl.get('axisLabel.margin');
	     ...
	     * @param  {module:echarts/mdl/Option} option
	     * @private
	     */
...
/***/ function(module, exports, __webpack_require__) {
	     ...
	     */
	    axisHelper.getScaleExtent = function (axis, mdl) {
	        ...
	        var min = mdl.getMin ? mdl.getMin() : mdl.get('min');
	        var max = mdl.getMax ? mdl.getMax() : mdl.get('max');
	        var crossZero = mdl.getNeedCrossZero
	            ? mdl.getNeedCrossZero() : !mdl.get('scale');
	        var boundaryGap = mdl.get('boundaryGap');
	    ...
	    axisHelper.niceScaleExtent = function (axis, mdl) {
	        var scale = axis.scale;
	        var extent = axisHelper.getScaleExtent(axis, mdl);
	        var fixMin = (mdl.getMin ? mdl.getMin() : mdl.get('min')) != null;
	        var fixMax = (mdl.getMax ? mdl.getMax() : mdl.get('max')) != null;
	        var splitNumber = mdl.get('splitNumber');
	        ...
	        //  an integer axis.
	        var minInterval = mdl.get('minInterval');
	    ...
	    /**
	     * @param {module:echarts/mdl/Model} mdl
	     * @param {string} [axisType] Default retrieve from mdl.type
	     * @return {module:echarts/scale/*}
	     */
	    axisHelper.createScaleByModel = function(mdl, axisType) {
	        axisType = axisType || mdl.get('type');
	        if (axisType) {
	            switch (axisType) {
	                // Buildin scale
	                case 'category':
	                    return new OrdinalScale(
	                        mdl.getCategories(), [Infinity, -Infinity]
	                    );
	                case 'value':
	                    return new IntervalScale();
	                // Extended scale, like time and log
	                default:
	                    return (Scale.getClass(axisType) || IntervalScale).create(mdl);
	            }
	        }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    /**
	     * Generate sub axis mdl class
	     * @param {string} axisName 'x' 'y' 'radius' 'angle' 'parallel'
	     * @param {module:echarts/mdl/Component} BaseAxisModelClass
...
/***/ function(module, exports, __webpack_require__) {
	     ...
	     *                                     interval from mdl is null or 'auto'.
	     ...
	     * @static
	     */
	    var getInterval = AxisBuilder.getInterval = function (mdl, labelInterval) {
	        var interval = mdl.get('interval');
	...
	'use strict';
	    ...
	    module.exports = __webpack_require__(1).extendChartView({
	        ...
	        _updateStyle: function (seriesModel, data, isHorizontal) {
	            function setLabel(style, mdl, color, labelText, labelPositionOutside) {
	                graphic.setText(style, mdl, color);
