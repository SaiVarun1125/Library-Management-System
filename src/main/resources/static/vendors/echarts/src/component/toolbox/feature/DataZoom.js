define(function(require) {
    ...
    // Spectial component id start with \0ec\0, see echarts/mdl/Global.js~hasInnerId
    var DATA_ZOOM_ID_BASE = '\0_ec_\0toolbox-dataZoom_';

    function DataZoom(mdl) {
        this.mdl = mdl;
    ...
    proto.onclick = function (ecModel, api, type) {
        ...
        handlers[type].call(this, controllerGroup, this.mdl, ecModel, api);
    };
    ...
    function prepareCoordInfo(grid, ecModel) {
        ...
        // FIXME
        var coordInfo = [
            {axisModel: grid.getAxis('x').mdl, axisIndex: 0}, // x
            {axisModel: grid.getAxis('y').mdl, axisIndex: 0}  // y
        ];
        coordInfo.grid = grid;
