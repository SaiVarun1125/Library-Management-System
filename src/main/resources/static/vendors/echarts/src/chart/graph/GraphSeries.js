    ...
    var GraphSeries = require('../../echarts').extendSeriesModel({
        ...
        getInitialData: function (option, ecModel) {
            ...
            function beforeLink(nodeData, edgeData) {
                ...
                nodeData.wrapMethod('getItemModel', function (mdl) {
                    var categoriesModels = self._categoriesModels;
                    var categoryIdx = mdl.getShallow('category');
                    var categoryModel = categoriesModels[categoryIdx];
                    if (categoryModel) {
                        categoryModel.parentModel = mdl.parentModel;
                        mdl.parentModel = categoryModel;
                    }
                    return mdl;
                });
                ...
                var wrappedGetEdgeModel = function (path, parentModel) {
                    ...
                    var mdl = Model.prototype.getModel.call(this, pathArr, parentModel);
                    mdl.getModel = wrappedGetEdgeModel;
                    return mdl;
                };
                edgeData.wrapMethod('getItemModel', function (mdl) {
